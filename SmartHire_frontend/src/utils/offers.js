...
export const CV_ANALYSIS_SCORE_API_URL =
  import.meta.env.VITE_CV_ANALYSIS_SCORE_API_URL || 'http://localhost:8086/api/cv-analysis/score-for-offer'
export const CV_ANALYSIS_CHATBOT_API_URL =
  import.meta.env.VITE_CV_ANALYSIS_CHATBOT_API_URL || 'http://localhost:8086/api/cv-analysis/chatbot-cv-advice'
export const CV_ANALYSIS_APPLY_API_URL =
  import.meta.env.VITE_CV_ANALYSIS_APPLY_API_URL || 'http://localhost:8086/api/cv-analysis/apply-for-offer'
